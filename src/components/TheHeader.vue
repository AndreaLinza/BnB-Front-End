      ...
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
          ...
          <span class="h-100"><img class="img-nav" src="../../navicon-white.png" style="width:40px" alt="navicon">
            <img class="d-none img-nav-hover" src="../../navicon-orange.png" style="width:40px" alt="navicon"></span>
        </button>
          ...
          <div class="fake-searchbar">
            <div class="underbar">
              <button class="btn d-flex" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                ...
                <div class="all-right">
                  <img class="d-none d-lg-block" src="../../transition-navicon.png" alt="navicon" style="width: 30px;">
                </div>
              </button>
            </div>
          </div>
