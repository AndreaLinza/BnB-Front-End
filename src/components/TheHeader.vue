    ...
    <nav class="navbar navbar-expand-lg shadow-lg">
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
          ...
          <span class="h-100"><img class="d-none" src="../../public/navicon-orange.png" style="width:40px"
              alt="navico"></span>
        </button>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex input-group w-50 mx-lg-auto search-bar" action="POST" @submit.prevent="submitResearch()"
            role="search">
